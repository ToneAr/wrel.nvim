...
local highlights = {
	...
	-- Render Markdown
	RenderMarkdownH1Bg = { bg = "#808080", fg = "#ffffff" },
	RenderMarkdownH2Bg = { bg = "#656565", fg = "#ffffff" },
	RenderMarkdownH3Bg = { bg = "#454545", fg = "#ffffff" },
	RenderMarkdownH4Bg = { bg = "#252525", fg = "#ffffff" },
	RenderMarkdownH5Bg = { bg = "none", fg = colors.gray },
	RenderMarkdownH6Bg = { bg = "none", fg = colors.gray },
	RenderMarkdownCode = { link = "MarkdownCodeBlock" },
	MarkdownCodeBlock = { bg = colors.dark_bg },
	RenderMarkdownCodeInline = { fg = colors.active_line_nr },
	RenderMarkdownTableHead = { fg = colors.indent_guide },
	RenderMarkdownTableRow = { fg = colors.indent_guide },
	RenderMarkdownQuote = { fg = colors.yellow },
	["@markup.quote.markdown"] = { fg = colors.yellow },
	["@markup.heading.markdown"] = { fg = colors.gray },
